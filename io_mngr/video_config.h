...
#define VIDEO_DEFAULT_TILE_COUNT 1

#define VIDEO_DEFAULT_INTERNAL_WIDTH VIDEO_MAX_WIDTH
#define VIDEO_DEFAULT_INTERNAL_HEIGHT VIDEO_MAX_HEIGHT
#define VIDEO_DEFAULT_INTERNAL_CODEC RAW

#define VIDEO_DEFAULT_EXTERNAL_WIDTH VIDEO_MAX_WIDTH
#define VIDEO_DEFAULT_EXTERNAL_HEIGHT VIDEO_MAX_HEIGHT
