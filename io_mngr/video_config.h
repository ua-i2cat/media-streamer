...
#define VIDEO_DECODED_CIRCULAR_QUEUE_SIZE 16
#define VIDEO_CODED_CIRCULAR_QUEUE_SIZE 2
...
#define VIDEO_DEFAULT_TYPE BFRAME

#define VIDEO_DEFAULT_INTERLACING 0
#define VIDEO_DEFAULT_TILE_COUNT 0

#define VIDEO_DEFAULT_INTERNAL_WIDTH 0
#define VIDEO_DEFAULT_INTERNAL_HEIGHT 0
...
#define VIDEO_DEFAULT_EXTERNAL_WIDTH 0
#define VIDEO_DEFAULT_EXTERNAL_HEIGHT 0
